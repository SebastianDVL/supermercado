        ...
        <section>
            <div class="container">
                        <form id="form1" runat="server" class="d-flex flex-column">
                             <div class="mb-3">
                                 <asp:Label ID="Label1" runat="server" CssClass="form-label" Text="Identificacion"></asp:Label>
                                 <asp:TextBox ID="txtId" runat="server" CssClass="form-control"></asp:TextBox>
                     
                              </div>
                              <div class="mb-3">
                                 <asp:Label ID="Label2" runat="server" CssClass="form-label" Text="Identificacion"></asp:Label>
                                 <asp:TextBox ID="txtPassword" runat="server" CssClass="form-control" type="password"></asp:TextBox>
                              </div>
                             <asp:Label ID="lblMsg" runat="server" Text=""></asp:Label>
             
                            <asp:Button ID="btSubmit" runat="server" Text="Inresar" CssClass="btn btn-primary" OnClick="btSubmit_Click" />
                         </form>
                  </div>
